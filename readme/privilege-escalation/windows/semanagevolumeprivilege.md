...
Using the exploit https://github.com/CsEnox/SeManageVolumeExploit/releases
...
**For other dlls to overwrite check:** Use dllref to check dll to replace to get a reverse shell:
